...
// var map = L.map('map').setView([10, -10.0], 13);
// // ajout d'une couche pour avoir un visuel de la carte
        ...
        .then((data) => {
            ...
            data.forEach((ville) => {
             ...
             data.forEach((ville) => {
                ...
                var marker = L.marker([`${ville.centre.coordinates[0]}`, `${ville.centre.coordinates[1]}`]).addTo(map)
            })
